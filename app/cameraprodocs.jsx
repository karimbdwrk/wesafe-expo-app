					...
					<VStack space='xl' style={{ alignItems: "center" }}>
						...
						<VStack space='sm' style={{ alignItems: "center" }}>
							...
							<Text
								...
								Pour photographier votre document, nous avons
				...
				<VStack style={{ flex: 1, justifyContent: "space-between" }}>
					...
					<Box
							...
							{[
								...
								<Box
									...
									style={{
										...
										borderColor: "#ffffff",
										borderTopWidth:
											pos.top !== undefined ? 3 : 0,
										borderBottomWidth:
											pos.bottom !== undefined ? 3 : 0,
										borderLeftWidth:
											pos.left !== undefined ? 3 : 0,
										borderRightWidth:
											pos.right !== undefined ? 3 : 0,
										...pos,
									}}
								/>
							))}
						...
						<Text
							...
							Cadrez le document dans le rectangle
						</Text>
					</Box>
